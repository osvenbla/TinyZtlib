...
#ifndef __TINYZTLIB_H__
#define __TINYZTLIB_H__
...
{
  private:
    int WriteBuff(uint8_t *buff,int);
  public:
    TinyZtlib(uint8_t);
    void I2cInit(void);
// Module ZT.SEG8B4A036A FUNCTION
    ...
    int Seg8b4a036aDisplayDecAndCode(uint8_t,unsigned short,uint8_t, uint8_t, uint8_t);
